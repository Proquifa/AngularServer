...
public class PendientesMensajeroPLRowMapper implements RowMapper {
	...
	public Object mapRow(ResultSet rs, int arg1) throws SQLException {
		...
		mensajero.setManejo(rs.getString("Manejo"));
		...
		mensajero.setActualizar(rs.getBoolean("Actualizar"));
		
		mensajero.setIdRuta(rs.getString("idRuta"));
		...
		if(rs.getString("idDP") != null) {
			if (rs.getString("idDP").contains("DP-")){
				mensajero.setFolioDocumento(rs.getString("idDP"));
			}else
		...
		//mensajero.setResponsable(rs.getString("Responsable"));
