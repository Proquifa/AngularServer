...
public class HorarioyLugarRevisionRowMapper implements RowMapper{
	...
	public Object mapRow(ResultSet rs, int arg1) throws SQLException {
		...
		horario.setIdHorario(rs.getLong("idHorario"));
		...
		direccion.setRuta(rs.getString("Ruta"));
		direccion.setZonaMensajeria(rs.getString("ZonaMensajeria"));
		direccion.setCodigoPostal(rs.getString("CP"));
		direccion.setMapa(rs.getString("Mapa"));
		direccion.setAltitud(rs.getDouble("Altitud"));
		...
		direccion.setHorarios(horarios);
		return direccion;
	}
