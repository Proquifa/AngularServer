...
public class PrintedReference  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.PrintedReferenceType type;
    ...
    public PrintedReference(
           com.proquifa.net.negocio.envio.ship.stub.PrintedReferenceType type,
     ...
     * @return type
     */
    public com.proquifa.net.negocio.envio.ship.stub.PrintedReferenceType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.PrintedReferenceType type) {
        this.type = type;
    }
