...
public class VariableHandlingChargeDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.Money fixedValue;
     ...
     * is applied. */
    private com.proquifa.net.negocio.envio.ship.stub.RateElementBasisType rateElementBasis;
    ...
    public VariableHandlingChargeDetail(
           com.proquifa.net.negocio.envio.ship.stub.Money fixedValue,
           java.math.BigDecimal percentValue,
           com.proquifa.net.negocio.envio.ship.stub.RateElementBasisType rateElementBasis,
     ...
     * @return fixedValue
     */
    public com.proquifa.net.negocio.envio.ship.stub.Money getFixedValue() {
        return fixedValue;
    }
     ...
     * @param fixedValue
     */
    public void setFixedValue(com.proquifa.net.negocio.envio.ship.stub.Money fixedValue) {
        this.fixedValue = fixedValue;
    }
     ...
     * is applied.
     */
    public com.proquifa.net.negocio.envio.ship.stub.RateElementBasisType getRateElementBasis() {
     ...
     * is applied.
     */
    public void setRateElementBasis(com.proquifa.net.negocio.envio.ship.stub.RateElementBasisType rateElementBasis) {
        this.rateElementBasis = rateElementBasis;
    }
