...
public class ShipmentManifestDetail  implements java.io.Serializable {
     ...
     * manifest ID. */
    private com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType manifestReferenceType;

    public ShipmentManifestDetail() {
    }

    public ShipmentManifestDetail(
           com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType manifestReferenceType) {
     ...
     * manifest ID.
     */
    public com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType getManifestReferenceType() {
     ...
     * manifest ID.
     */
    public void setManifestReferenceType(com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType manifestReferenceType) {
        this.manifestReferenceType = manifestReferenceType;
    }
