...
public class SignatureOptionDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.SignatureOptionType optionType;
    ...
    public SignatureOptionDetail(
           com.proquifa.net.negocio.envio.ship.stub.SignatureOptionType optionType,
     ...
     * @return optionType
     */
    public com.proquifa.net.negocio.envio.ship.stub.SignatureOptionType getOptionType() {
        return optionType;
    }
     ...
     * @param optionType
     */
    public void setOptionType(com.proquifa.net.negocio.envio.ship.stub.SignatureOptionType optionType) {
        this.optionType = optionType;
    }
