...
public class PickupDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.PickupRequestType requestType;

    private com.proquifa.net.negocio.envio.ship.stub.PickupRequestSourceType requestSource;
    ...
    public PickupDetail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.PickupRequestType requestType,
           com.proquifa.net.negocio.envio.ship.stub.PickupRequestSourceType requestSource) {
     ...
     * @return requestType
     */
    public com.proquifa.net.negocio.envio.ship.stub.PickupRequestType getRequestType() {
        return requestType;
    }
     ...
     * @param requestType
     */
    public void setRequestType(com.proquifa.net.negocio.envio.ship.stub.PickupRequestType requestType) {
        this.requestType = requestType;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.PickupRequestSourceType getRequestSource() {
        return requestSource;
    }
     ...
     * @param requestSource
     */
    public void setRequestSource(com.proquifa.net.negocio.envio.ship.stub.PickupRequestSourceType requestSource) {
        this.requestSource = requestSource;
    }
