...
public class Op900Detail  implements java.io.Serializable {
     ...
     * OP-900. */
    private com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType reference;
    ...
    public Op900Detail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType reference,
     ...
     * OP-900.
     */
    public com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType getReference() {
        return reference;
    }
     ...
     * OP-900.
     */
    public void setReference(com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType reference) {
        this.reference = reference;
    }
