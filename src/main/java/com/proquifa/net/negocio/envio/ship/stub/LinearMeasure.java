...
public class LinearMeasure  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.LinearUnits units;
    ...
    public LinearMeasure(
           ...
           com.proquifa.net.negocio.envio.ship.stub.LinearUnits units) {
           this.value = value;
           this.units = units;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.LinearUnits getUnits() {
        return units;
    }
     ...
     */
    public void setUnits(com.proquifa.net.negocio.envio.ship.stub.LinearUnits units) {
        this.units = units;
    }
