...
public class DocumentRequirementsDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.RequiredDocumentType[] requiredDocuments;

    private com.proquifa.net.negocio.envio.ship.stub.DocumentGenerationDetail[] generationDetails;

    /* Lists the documents that are not accepted by FedEx for this
     * shipment. */
    private com.proquifa.net.negocio.envio.ship.stub.EnterpriseDocumentType[] prohibitedDocuments;

    public DocumentRequirementsDetail() {
    }

    public DocumentRequirementsDetail(
           com.proquifa.net.negocio.envio.ship.stub.RequiredDocumentType[] requiredDocuments,
           com.proquifa.net.negocio.envio.ship.stub.DocumentGenerationDetail[] generationDetails,
           com.proquifa.net.negocio.envio.ship.stub.EnterpriseDocumentType[] prohibitedDocuments) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.RequiredDocumentType[] getRequiredDocuments() {
        return requiredDocuments;
    }
     ...
     */
    public void setRequiredDocuments(com.proquifa.net.negocio.envio.ship.stub.RequiredDocumentType[] requiredDocuments) {
        this.requiredDocuments = requiredDocuments;
    }

    public com.proquifa.net.negocio.envio.ship.stub.RequiredDocumentType getRequiredDocuments(int i) {
        return this.requiredDocuments[i];
    }

    public void setRequiredDocuments(int i, com.proquifa.net.negocio.envio.ship.stub.RequiredDocumentType _value) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.DocumentGenerationDetail[] getGenerationDetails() {
        return generationDetails;
    }
     ...
     */
    public void setGenerationDetails(com.proquifa.net.negocio.envio.ship.stub.DocumentGenerationDetail[] generationDetails) {
        this.generationDetails = generationDetails;
    }

    public com.proquifa.net.negocio.envio.ship.stub.DocumentGenerationDetail getGenerationDetails(int i) {
        return this.generationDetails[i];
    }

    public void setGenerationDetails(int i, com.proquifa.net.negocio.envio.ship.stub.DocumentGenerationDetail _value) {
     ...
     * shipment.
     */
    public com.proquifa.net.negocio.envio.ship.stub.EnterpriseDocumentType[] getProhibitedDocuments() {
     ...
     * shipment.
     */
    public void setProhibitedDocuments(com.proquifa.net.negocio.envio.ship.stub.EnterpriseDocumentType[] prohibitedDocuments) {
        this.prohibitedDocuments = prohibitedDocuments;
    }

    public com.proquifa.net.negocio.envio.ship.stub.EnterpriseDocumentType getProhibitedDocuments(int i) {
        return this.prohibitedDocuments[i];
    }

    public void setProhibitedDocuments(int i, com.proquifa.net.negocio.envio.ship.stub.EnterpriseDocumentType _value) {
