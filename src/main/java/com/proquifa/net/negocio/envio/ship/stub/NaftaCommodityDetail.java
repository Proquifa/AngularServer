...
public class NaftaCommodityDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.NaftaPreferenceCriterionCode preferenceCriterion;

    /* Defined by NAFTA regulations. */
    private com.proquifa.net.negocio.envio.ship.stub.NaftaProducerDeterminationCode producerDetermination;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.NaftaNetCostMethodCode netCostMethod;

    /* Date range over which RVC net cost was calculated. */
    private com.proquifa.net.negocio.envio.ship.stub.DateRange netCostDateRange;

    public NaftaCommodityDetail() {
    }

    public NaftaCommodityDetail(
           com.proquifa.net.negocio.envio.ship.stub.NaftaPreferenceCriterionCode preferenceCriterion,
           com.proquifa.net.negocio.envio.ship.stub.NaftaProducerDeterminationCode producerDetermination,
           java.lang.String producerId,
           com.proquifa.net.negocio.envio.ship.stub.NaftaNetCostMethodCode netCostMethod,
           com.proquifa.net.negocio.envio.ship.stub.DateRange netCostDateRange) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.NaftaPreferenceCriterionCode getPreferenceCriterion() {
     ...
     */
    public void setPreferenceCriterion(com.proquifa.net.negocio.envio.ship.stub.NaftaPreferenceCriterionCode preferenceCriterion) {
        this.preferenceCriterion = preferenceCriterion;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.NaftaProducerDeterminationCode getProducerDetermination() {
     ...
     */
    public void setProducerDetermination(com.proquifa.net.negocio.envio.ship.stub.NaftaProducerDeterminationCode producerDetermination) {
        this.producerDetermination = producerDetermination;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.NaftaNetCostMethodCode getNetCostMethod() {
        return netCostMethod;
    }
     ...
     * @param netCostMethod
     */
    public void setNetCostMethod(com.proquifa.net.negocio.envio.ship.stub.NaftaNetCostMethodCode netCostMethod) {
        this.netCostMethod = netCostMethod;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.DateRange getNetCostDateRange() {
     ...
     */
    public void setNetCostDateRange(com.proquifa.net.negocio.envio.ship.stub.DateRange netCostDateRange) {
        this.netCostDateRange = netCostDateRange;
    }
