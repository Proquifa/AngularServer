...
public class EmailOptionsRequested  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.EmailOptionType[] options;

    public EmailOptionsRequested() {
    }

    public EmailOptionsRequested(
           com.proquifa.net.negocio.envio.ship.stub.EmailOptionType[] options) {
     ...
     * @return options
     */
    public com.proquifa.net.negocio.envio.ship.stub.EmailOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.proquifa.net.negocio.envio.ship.stub.EmailOptionType[] options) {
        this.options = options;
    }

    public com.proquifa.net.negocio.envio.ship.stub.EmailOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.proquifa.net.negocio.envio.ship.stub.EmailOptionType _value) {
