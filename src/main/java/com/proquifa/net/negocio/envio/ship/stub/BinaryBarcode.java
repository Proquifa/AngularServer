...
public class BinaryBarcode  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.BinaryBarcodeType type;
    ...
    public BinaryBarcode(
           com.proquifa.net.negocio.envio.ship.stub.BinaryBarcodeType type,
           byte[] value) {
           this.type = type;
           this.value = value;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.BinaryBarcodeType getType() {
        return type;
    }
     ...
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.BinaryBarcodeType type) {
        this.type = type;
    }
