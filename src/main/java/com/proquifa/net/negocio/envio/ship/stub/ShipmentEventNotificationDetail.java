...
public class ShipmentEventNotificationDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.ShipmentNotificationAggregationType aggregationType;

    private java.lang.String personalMessage;

    private com.proquifa.net.negocio.envio.ship.stub.ShipmentEventNotificationSpecification[] eventNotifications;

    public ShipmentEventNotificationDetail() {
    }

    public ShipmentEventNotificationDetail(
           com.proquifa.net.negocio.envio.ship.stub.ShipmentNotificationAggregationType aggregationType,
           java.lang.String personalMessage,
           com.proquifa.net.negocio.envio.ship.stub.ShipmentEventNotificationSpecification[] eventNotifications) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.ShipmentNotificationAggregationType getAggregationType() {
        return aggregationType;
    }
     ...
     */
    public void setAggregationType(com.proquifa.net.negocio.envio.ship.stub.ShipmentNotificationAggregationType aggregationType) {
        this.aggregationType = aggregationType;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.ShipmentEventNotificationSpecification[] getEventNotifications() {
        return eventNotifications;
    }
     ...
     */
    public void setEventNotifications(com.proquifa.net.negocio.envio.ship.stub.ShipmentEventNotificationSpecification[] eventNotifications) {
        this.eventNotifications = eventNotifications;
    }

    public com.proquifa.net.negocio.envio.ship.stub.ShipmentEventNotificationSpecification getEventNotifications(int i) {
        return this.eventNotifications[i];
    }

    public void setEventNotifications(int i, com.proquifa.net.negocio.envio.ship.stub.ShipmentEventNotificationSpecification _value) {
