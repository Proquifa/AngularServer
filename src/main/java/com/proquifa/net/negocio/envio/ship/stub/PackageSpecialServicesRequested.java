...
public class PackageSpecialServicesRequested  implements java.io.Serializable {
     ...
     * shipment or package. */
    private com.proquifa.net.negocio.envio.ship.stub.PackageSpecialServiceType[] specialServiceTypes;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsDetail dangerousGoodsDetail;

    /* Provides details about the batteries or cells that are contained
     * within this specific package. */
    private com.proquifa.net.negocio.envio.ship.stub.BatteryClassificationDetail[] batteryDetails;

    private com.proquifa.net.negocio.envio.ship.stub.Weight dryIceWeight;

    private com.proquifa.net.negocio.envio.ship.stub.SignatureOptionDetail signatureOptionDetail;

    private com.proquifa.net.negocio.envio.ship.stub.PriorityAlertDetail priorityAlertDetail;

    private com.proquifa.net.negocio.envio.ship.stub.AlcoholDetail alcoholDetail;

    public PackageSpecialServicesRequested() {
    }

    public PackageSpecialServicesRequested(
           com.proquifa.net.negocio.envio.ship.stub.PackageSpecialServiceType[] specialServiceTypes,
           com.proquifa.net.negocio.envio.ship.stub.CodDetail codDetail,
           com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsDetail dangerousGoodsDetail,
           com.proquifa.net.negocio.envio.ship.stub.BatteryClassificationDetail[] batteryDetails,
           com.proquifa.net.negocio.envio.ship.stub.Weight dryIceWeight,
           com.proquifa.net.negocio.envio.ship.stub.SignatureOptionDetail signatureOptionDetail,
           com.proquifa.net.negocio.envio.ship.stub.PriorityAlertDetail priorityAlertDetail,
           com.proquifa.net.negocio.envio.ship.stub.AlcoholDetail alcoholDetail) {
     ...
     * shipment or package.
     */
    public com.proquifa.net.negocio.envio.ship.stub.PackageSpecialServiceType[] getSpecialServiceTypes() {
     ...
     * shipment or package.
     */
    public void setSpecialServiceTypes(com.proquifa.net.negocio.envio.ship.stub.PackageSpecialServiceType[] specialServiceTypes) {
        this.specialServiceTypes = specialServiceTypes;
    }

    public com.proquifa.net.negocio.envio.ship.stub.PackageSpecialServiceType getSpecialServiceTypes(int i) {
        return this.specialServiceTypes[i];
    }

    public void setSpecialServiceTypes(int i, com.proquifa.net.negocio.envio.ship.stub.PackageSpecialServiceType _value) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsDetail getDangerousGoodsDetail() {
        return dangerousGoodsDetail;
    }
     ...
     */
    public void setDangerousGoodsDetail(com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsDetail dangerousGoodsDetail) {
        this.dangerousGoodsDetail = dangerousGoodsDetail;
    }
     ...
     * within this specific package.
     */
    public com.proquifa.net.negocio.envio.ship.stub.BatteryClassificationDetail[] getBatteryDetails() {
     ...
     * within this specific package.
     */
    public void setBatteryDetails(com.proquifa.net.negocio.envio.ship.stub.BatteryClassificationDetail[] batteryDetails) {
        this.batteryDetails = batteryDetails;
    }

    public com.proquifa.net.negocio.envio.ship.stub.BatteryClassificationDetail getBatteryDetails(int i) {
        return this.batteryDetails[i];
    }

    public void setBatteryDetails(int i, com.proquifa.net.negocio.envio.ship.stub.BatteryClassificationDetail _value) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.SignatureOptionDetail getSignatureOptionDetail() {
        return signatureOptionDetail;
    }
     ...
     */
    public void setSignatureOptionDetail(com.proquifa.net.negocio.envio.ship.stub.SignatureOptionDetail signatureOptionDetail) {
        this.signatureOptionDetail = signatureOptionDetail;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.PriorityAlertDetail getPriorityAlertDetail() {
        return priorityAlertDetail;
    }
     ...
     */
    public void setPriorityAlertDetail(com.proquifa.net.negocio.envio.ship.stub.PriorityAlertDetail priorityAlertDetail) {
        this.priorityAlertDetail = priorityAlertDetail;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.AlcoholDetail getAlcoholDetail() {
        return alcoholDetail;
    }
     ...
     * @param alcoholDetail
     */
    public void setAlcoholDetail(com.proquifa.net.negocio.envio.ship.stub.AlcoholDetail alcoholDetail) {
        this.alcoholDetail = alcoholDetail;
    }
