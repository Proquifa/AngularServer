...
public class AdrLicenseDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.LicenseOrPermitDetail licenseOrPermitDetail;

    public AdrLicenseDetail() {
    }

    public AdrLicenseDetail(
           com.proquifa.net.negocio.envio.ship.stub.LicenseOrPermitDetail licenseOrPermitDetail) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.LicenseOrPermitDetail getLicenseOrPermitDetail() {
        return licenseOrPermitDetail;
    }
     ...
     */
    public void setLicenseOrPermitDetail(com.proquifa.net.negocio.envio.ship.stub.LicenseOrPermitDetail licenseOrPermitDetail) {
        this.licenseOrPermitDetail = licenseOrPermitDetail;
    }
