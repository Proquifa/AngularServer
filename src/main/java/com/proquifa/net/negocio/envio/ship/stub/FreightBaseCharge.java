...
public class FreightBaseCharge  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.FreightClassType ratedAsClass;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.Money chargeRate;

    /* Identifies the manner in which the chargeRate for this line
     * item was applied. */
    private com.proquifa.net.negocio.envio.ship.stub.FreightChargeBasisType chargeBasis;

    /* The net or extended charge for this line item. */
    private com.proquifa.net.negocio.envio.ship.stub.Money extendedAmount;
    ...
    public FreightBaseCharge(
           ...
           com.proquifa.net.negocio.envio.ship.stub.FreightClassType ratedAsClass,
           java.lang.String nmfcCode,
           java.lang.String description,
           com.proquifa.net.negocio.envio.ship.stub.Weight weight,
           com.proquifa.net.negocio.envio.ship.stub.Money chargeRate,
           com.proquifa.net.negocio.envio.ship.stub.FreightChargeBasisType chargeBasis,
           com.proquifa.net.negocio.envio.ship.stub.Money extendedAmount) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.FreightClassType getRatedAsClass() {
        return ratedAsClass;
    }
     ...
     */
    public void setRatedAsClass(com.proquifa.net.negocio.envio.ship.stub.FreightClassType ratedAsClass) {
        this.ratedAsClass = ratedAsClass;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.Money getChargeRate() {
        return chargeRate;
    }
     ...
     */
    public void setChargeRate(com.proquifa.net.negocio.envio.ship.stub.Money chargeRate) {
        this.chargeRate = chargeRate;
    }
     ...
     * item was applied.
     */
    public com.proquifa.net.negocio.envio.ship.stub.FreightChargeBasisType getChargeBasis() {
        return chargeBasis;
    }
     ...
     * item was applied.
     */
    public void setChargeBasis(com.proquifa.net.negocio.envio.ship.stub.FreightChargeBasisType chargeBasis) {
        this.chargeBasis = chargeBasis;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.Money getExtendedAmount() {
     ...
     */
    public void setExtendedAmount(com.proquifa.net.negocio.envio.ship.stub.Money extendedAmount) {
        this.extendedAmount = extendedAmount;
    }
