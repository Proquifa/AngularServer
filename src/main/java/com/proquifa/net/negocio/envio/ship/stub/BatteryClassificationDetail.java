...
public class BatteryClassificationDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.BatteryMaterialType material;

    /* Describes the packing arrangement of the battery or cell with
     * respect to other items within the same package. */
    private com.proquifa.net.negocio.envio.ship.stub.BatteryPackingType packing;

    /* A regulation specific classification for the battery or cell. */
    private com.proquifa.net.negocio.envio.ship.stub.BatteryRegulatorySubType regulatorySubType;

    public BatteryClassificationDetail() {
    }

    public BatteryClassificationDetail(
           com.proquifa.net.negocio.envio.ship.stub.BatteryMaterialType material,
           com.proquifa.net.negocio.envio.ship.stub.BatteryPackingType packing,
           com.proquifa.net.negocio.envio.ship.stub.BatteryRegulatorySubType regulatorySubType) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.BatteryMaterialType getMaterial() {
        return material;
    }
     ...
     */
    public void setMaterial(com.proquifa.net.negocio.envio.ship.stub.BatteryMaterialType material) {
        this.material = material;
    }
     ...
     * respect to other items within the same package.
     */
    public com.proquifa.net.negocio.envio.ship.stub.BatteryPackingType getPacking() {
        return packing;
    }
     ...
     * respect to other items within the same package.
     */
    public void setPacking(com.proquifa.net.negocio.envio.ship.stub.BatteryPackingType packing) {
        this.packing = packing;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.BatteryRegulatorySubType getRegulatorySubType() {
     ...
     */
    public void setRegulatorySubType(com.proquifa.net.negocio.envio.ship.stub.BatteryRegulatorySubType regulatorySubType) {
        this.regulatorySubType = regulatorySubType;
    }
