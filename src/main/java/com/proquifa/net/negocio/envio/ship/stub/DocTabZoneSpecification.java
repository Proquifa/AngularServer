...
public class DocTabZoneSpecification  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.DocTabZoneJustificationType justification;
    ...
    public DocTabZoneSpecification(
           ...
           com.proquifa.net.negocio.envio.ship.stub.DocTabZoneJustificationType justification) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.DocTabZoneJustificationType getJustification() {
        return justification;
    }
     ...
     * @param justification
     */
    public void setJustification(com.proquifa.net.negocio.envio.ship.stub.DocTabZoneJustificationType justification) {
        this.justification = justification;
    }
