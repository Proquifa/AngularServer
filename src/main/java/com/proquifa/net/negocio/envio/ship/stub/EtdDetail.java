...
public class EtdDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.EtdAttributeType[] attributes;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.RequestedShippingDocumentType[] requestedDocumentCopies;
    ...
    public EtdDetail(
           com.proquifa.net.negocio.envio.ship.stub.EtdAttributeType[] attributes,
           com.proquifa.net.negocio.envio.ship.stub.RequestedShippingDocumentType[] requestedDocumentCopies,
     ...
     * @return attributes
     */
    public com.proquifa.net.negocio.envio.ship.stub.EtdAttributeType[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(com.proquifa.net.negocio.envio.ship.stub.EtdAttributeType[] attributes) {
        this.attributes = attributes;
    }

    public com.proquifa.net.negocio.envio.ship.stub.EtdAttributeType getAttributes(int i) {
        return this.attributes[i];
    }

    public void setAttributes(int i, com.proquifa.net.negocio.envio.ship.stub.EtdAttributeType _value) {
     ...
     * be copied back to the shipper in the shipment result data.
     */
    public com.proquifa.net.negocio.envio.ship.stub.RequestedShippingDocumentType[] getRequestedDocumentCopies() {
     ...
     * be copied back to the shipper in the shipment result data.
     */
    public void setRequestedDocumentCopies(com.proquifa.net.negocio.envio.ship.stub.RequestedShippingDocumentType[] requestedDocumentCopies) {
        this.requestedDocumentCopies = requestedDocumentCopies;
    }

    public com.proquifa.net.negocio.envio.ship.stub.RequestedShippingDocumentType getRequestedDocumentCopies(int i) {
        return this.requestedDocumentCopies[i];
    }

    public void setRequestedDocumentCopies(int i, com.proquifa.net.negocio.envio.ship.stub.RequestedShippingDocumentType _value) {
