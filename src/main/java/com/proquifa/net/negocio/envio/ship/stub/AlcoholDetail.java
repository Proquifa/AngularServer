...
public class AlcoholDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.AlcoholRecipientType recipientType;

    public AlcoholDetail() {
    }

    public AlcoholDetail(
           com.proquifa.net.negocio.envio.ship.stub.AlcoholRecipientType recipientType) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.AlcoholRecipientType getRecipientType() {
     ...
     */
    public void setRecipientType(com.proquifa.net.negocio.envio.ship.stub.AlcoholRecipientType recipientType) {
        this.recipientType = recipientType;
    }
