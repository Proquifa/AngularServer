...
public class CustomerReference  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType customerReferenceType;
    ...
    public CustomerReference(
           com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType customerReferenceType,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType getCustomerReferenceType() {
        return customerReferenceType;
    }
     ...
     */
    public void setCustomerReferenceType(com.proquifa.net.negocio.envio.ship.stub.CustomerReferenceType customerReferenceType) {
        this.customerReferenceType = customerReferenceType;
    }
