...
public class CustomLabelTextBoxEntry  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition topLeftCorner;

    private com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition bottomRightCorner;

    private com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition position;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.RotationType rotation;

    public CustomLabelTextBoxEntry() {
    }

    public CustomLabelTextBoxEntry(
           com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition topLeftCorner,
           com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition bottomRightCorner,
           com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition position,
           java.lang.String format,
           java.lang.String[] dataFields,
           java.lang.String thermalFontId,
           java.lang.String fontName,
           org.apache.axis.types.PositiveInteger fontSize,
           com.proquifa.net.negocio.envio.ship.stub.RotationType rotation) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition getTopLeftCorner() {
        return topLeftCorner;
    }
     ...
     * @param topLeftCorner
     */
    public void setTopLeftCorner(com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition topLeftCorner) {
        this.topLeftCorner = topLeftCorner;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition getBottomRightCorner() {
        return bottomRightCorner;
    }
     ...
     */
    public void setBottomRightCorner(com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition bottomRightCorner) {
        this.bottomRightCorner = bottomRightCorner;
    }
     ...
     * @return position
     */
    public com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition getPosition() {
        return position;
    }
     ...
     * @param position
     */
    public void setPosition(com.proquifa.net.negocio.envio.ship.stub.CustomLabelPosition position) {
        this.position = position;
    }
     ...
     * @return rotation
     */
    public com.proquifa.net.negocio.envio.ship.stub.RotationType getRotation() {
        return rotation;
    }
     ...
     * @param rotation
     */
    public void setRotation(com.proquifa.net.negocio.envio.ship.stub.RotationType rotation) {
        this.rotation = rotation;
    }
