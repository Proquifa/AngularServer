...
public class CompletedHoldAtLocationDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.ContactAndAddress holdingLocation;

    /* Identifies the type of FedEx location. */
    private com.proquifa.net.negocio.envio.ship.stub.FedExLocationType holdingLocationType;
    ...
    public CompletedHoldAtLocationDetail(
           com.proquifa.net.negocio.envio.ship.stub.ContactAndAddress holdingLocation,
           com.proquifa.net.negocio.envio.ship.stub.FedExLocationType holdingLocationType,
     ...
     * phone number and the address of the location.
     */
    public com.proquifa.net.negocio.envio.ship.stub.ContactAndAddress getHoldingLocation() {
     ...
     * phone number and the address of the location.
     */
    public void setHoldingLocation(com.proquifa.net.negocio.envio.ship.stub.ContactAndAddress holdingLocation) {
        this.holdingLocation = holdingLocation;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.FedExLocationType getHoldingLocationType() {
     ...
     */
    public void setHoldingLocationType(com.proquifa.net.negocio.envio.ship.stub.FedExLocationType holdingLocationType) {
        this.holdingLocationType = holdingLocationType;
    }
