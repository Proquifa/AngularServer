...
public class ShipmentDryIceProcessingOptionsRequested  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.ShipmentDryIceProcessingOptionType[] options;

    public ShipmentDryIceProcessingOptionsRequested() {
    }

    public ShipmentDryIceProcessingOptionsRequested(
           com.proquifa.net.negocio.envio.ship.stub.ShipmentDryIceProcessingOptionType[] options) {
     ...
     * @return options
     */
    public com.proquifa.net.negocio.envio.ship.stub.ShipmentDryIceProcessingOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.proquifa.net.negocio.envio.ship.stub.ShipmentDryIceProcessingOptionType[] options) {
        this.options = options;
    }

    public com.proquifa.net.negocio.envio.ship.stub.ShipmentDryIceProcessingOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.proquifa.net.negocio.envio.ship.stub.ShipmentDryIceProcessingOptionType _value) {
