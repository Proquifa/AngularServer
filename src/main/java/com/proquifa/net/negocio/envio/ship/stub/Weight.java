...
public class Weight  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.WeightUnits units;
    ...
    public Weight(
           com.proquifa.net.negocio.envio.ship.stub.WeightUnits units,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.WeightUnits getUnits() {
        return units;
    }
     ...
     */
    public void setUnits(com.proquifa.net.negocio.envio.ship.stub.WeightUnits units) {
        this.units = units;
    }
