...
public class DocumentGenerationDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.EnterpriseDocumentType type;

    private org.apache.axis.types.NonNegativeInteger minimumCopiesRequired;

    private com.proquifa.net.negocio.envio.ship.stub.RequirementType letterhead;

    private com.proquifa.net.negocio.envio.ship.stub.RequirementType electronicSignature;

    public DocumentGenerationDetail() {
    }

    public DocumentGenerationDetail(
           com.proquifa.net.negocio.envio.ship.stub.EnterpriseDocumentType type,
           org.apache.axis.types.NonNegativeInteger minimumCopiesRequired,
           com.proquifa.net.negocio.envio.ship.stub.RequirementType letterhead,
           com.proquifa.net.negocio.envio.ship.stub.RequirementType electronicSignature) {
           this.type = type;
     ...
     * @return type
     */
    public com.proquifa.net.negocio.envio.ship.stub.EnterpriseDocumentType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.EnterpriseDocumentType type) {
        this.type = type;
    }
     ...
     * @return letterhead
     */
    public com.proquifa.net.negocio.envio.ship.stub.RequirementType getLetterhead() {
        return letterhead;
    }
     ...
     * @param letterhead
     */
    public void setLetterhead(com.proquifa.net.negocio.envio.ship.stub.RequirementType letterhead) {
        this.letterhead = letterhead;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.RequirementType getElectronicSignature() {
        return electronicSignature;
    }
     ...
     */
    public void setElectronicSignature(com.proquifa.net.negocio.envio.ship.stub.RequirementType electronicSignature) {
        this.electronicSignature = electronicSignature;
    }
