...
public class HazardousCommodityDescription  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackingGroupType packingGroup;

    private com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackingDetail packingDetails;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityDescriptionProcessingOptionType[] processingOptions;
    ...
    public HazardousCommodityDescription(
           ...
           com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackingGroupType packingGroup,
           com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackingDetail packingDetails,
           ...
           com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityDescriptionProcessingOptionType[] processingOptions,
     ...
     * @return packingGroup
     */
    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackingGroupType getPackingGroup() {
        return packingGroup;
    }
     ...
     * @param packingGroup
     */
    public void setPackingGroup(com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackingGroupType packingGroup) {
        this.packingGroup = packingGroup;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackingDetail getPackingDetails() {
        return packingDetails;
    }
     ...
     */
    public void setPackingDetails(com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackingDetail packingDetails) {
        this.packingDetails = packingDetails;
    }
     ...
     * description of the dangerous goods commodity.
     */
    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityDescriptionProcessingOptionType[] getProcessingOptions() {
     ...
     * description of the dangerous goods commodity.
     */
    public void setProcessingOptions(com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityDescriptionProcessingOptionType[] processingOptions) {
        this.processingOptions = processingOptions;
    }

    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityDescriptionProcessingOptionType getProcessingOptions(int i) {
        return this.processingOptions[i];
    }

    public void setProcessingOptions(int i, com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityDescriptionProcessingOptionType _value) {
