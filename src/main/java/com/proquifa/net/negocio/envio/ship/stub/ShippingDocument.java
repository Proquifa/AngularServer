...
public class ShippingDocument  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.ReturnedShippingDocumentType type;

    /* The localizations are populated if multiple language versions
     * of a shipping document are returned. */
    private com.proquifa.net.negocio.envio.ship.stub.Localization[] localizations;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.ShippingDocumentDispositionType shippingDocumentDisposition;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.ShippingDocumentPart[] parts;

    public ShippingDocument() {
    }

    public ShippingDocument(
           com.proquifa.net.negocio.envio.ship.stub.ReturnedShippingDocumentType type,
           com.proquifa.net.negocio.envio.ship.stub.Localization[] localizations,
           com.proquifa.net.negocio.envio.ship.stub.ShippingDocumentGroupingType grouping,
           com.proquifa.net.negocio.envio.ship.stub.ShippingDocumentDispositionType shippingDocumentDisposition,
           ...
           com.proquifa.net.negocio.envio.ship.stub.ShippingDocumentPart[] parts) {
           this.type = type;
     ...
     * @return type
     */
    public com.proquifa.net.negocio.envio.ship.stub.ReturnedShippingDocumentType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.ReturnedShippingDocumentType type) {
        this.type = type;
    }
     ...
     * of a shipping document are returned.
     */
    public com.proquifa.net.negocio.envio.ship.stub.Localization[] getLocalizations() {
     ...
     * of a shipping document are returned.
     */
    public void setLocalizations(com.proquifa.net.negocio.envio.ship.stub.Localization[] localizations) {
        this.localizations = localizations;
    }

    public com.proquifa.net.negocio.envio.ship.stub.Localization getLocalizations(int i) {
        return this.localizations[i];
    }

    public void setLocalizations(int i, com.proquifa.net.negocio.envio.ship.stub.Localization _value) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.ShippingDocumentDispositionType getShippingDocumentDisposition() {
        return shippingDocumentDisposition;
    }
     ...
     */
    public void setShippingDocumentDisposition(com.proquifa.net.negocio.envio.ship.stub.ShippingDocumentDispositionType shippingDocumentDisposition) {
        this.shippingDocumentDisposition = shippingDocumentDisposition;
    }
     ...
     * such as multiple pages of a single form.
     */
    public com.proquifa.net.negocio.envio.ship.stub.ShippingDocumentPart[] getParts() {
        return parts;
    }
     ...
     * such as multiple pages of a single form.
     */
    public void setParts(com.proquifa.net.negocio.envio.ship.stub.ShippingDocumentPart[] parts) {
        this.parts = parts;
    }

    public com.proquifa.net.negocio.envio.ship.stub.ShippingDocumentPart getParts(int i) {
        return this.parts[i];
    }

    public void setParts(int i, com.proquifa.net.negocio.envio.ship.stub.ShippingDocumentPart _value) {
        this.parts[i] = _value;
    }
