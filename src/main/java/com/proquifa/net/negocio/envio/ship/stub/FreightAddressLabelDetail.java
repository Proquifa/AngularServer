...
public class FreightAddressLabelDetail  implements java.io.Serializable {
     ...
     * will start. */
    private com.proquifa.net.negocio.envio.ship.stub.PageQuadrantType startingPosition;
    ...
    public FreightAddressLabelDetail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.PageQuadrantType startingPosition,
     ...
     * will start.
     */
    public com.proquifa.net.negocio.envio.ship.stub.PageQuadrantType getStartingPosition() {
     ...
     * will start.
     */
    public void setStartingPosition(com.proquifa.net.negocio.envio.ship.stub.PageQuadrantType startingPosition) {
        this.startingPosition = startingPosition;
    }
