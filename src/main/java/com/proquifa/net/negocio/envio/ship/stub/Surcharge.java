...
public class Surcharge  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.SurchargeType surchargeType;

    private com.proquifa.net.negocio.envio.ship.stub.SurchargeLevelType level;
    ...
    public Surcharge(
           com.proquifa.net.negocio.envio.ship.stub.SurchargeType surchargeType,
           com.proquifa.net.negocio.envio.ship.stub.SurchargeLevelType level,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.SurchargeType getSurchargeType() {
        return surchargeType;
    }
     ...
     * @param surchargeType
     */
    public void setSurchargeType(com.proquifa.net.negocio.envio.ship.stub.SurchargeType surchargeType) {
        this.surchargeType = surchargeType;
    }
     ...
     * @return level
     */
    public com.proquifa.net.negocio.envio.ship.stub.SurchargeLevelType getLevel() {
        return level;
    }
     ...
     * @param level
     */
    public void setLevel(com.proquifa.net.negocio.envio.ship.stub.SurchargeLevelType level) {
        this.level = level;
    }
