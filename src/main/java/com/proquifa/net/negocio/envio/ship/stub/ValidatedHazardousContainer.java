...
public class ValidatedHazardousContainer  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.ValidatedHazardousCommodityContent[] hazardousCommodities;
    ...
    public ValidatedHazardousContainer(
           ...
           com.proquifa.net.negocio.envio.ship.stub.ValidatedHazardousCommodityContent[] hazardousCommodities) {
           this.QValue = QValue;
     ...
     * in the current package.
     */
    public com.proquifa.net.negocio.envio.ship.stub.ValidatedHazardousCommodityContent[] getHazardousCommodities() {
     ...
     * in the current package.
     */
    public void setHazardousCommodities(com.proquifa.net.negocio.envio.ship.stub.ValidatedHazardousCommodityContent[] hazardousCommodities) {
        this.hazardousCommodities = hazardousCommodities;
    }

    public com.proquifa.net.negocio.envio.ship.stub.ValidatedHazardousCommodityContent getHazardousCommodities(int i) {
        return this.hazardousCommodities[i];
    }

    public void setHazardousCommodities(int i, com.proquifa.net.negocio.envio.ship.stub.ValidatedHazardousCommodityContent _value) {
