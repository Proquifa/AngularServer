...
public class HomeDeliveryPremiumDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.HomeDeliveryPremiumType homeDeliveryPremiumType;
    ...
    public HomeDeliveryPremiumDetail(
           com.proquifa.net.negocio.envio.ship.stub.HomeDeliveryPremiumType homeDeliveryPremiumType,
           java.util.Date date,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.HomeDeliveryPremiumType getHomeDeliveryPremiumType() {
        return homeDeliveryPremiumType;
    }
     ...
     */
    public void setHomeDeliveryPremiumType(com.proquifa.net.negocio.envio.ship.stub.HomeDeliveryPremiumType homeDeliveryPremiumType) {
        this.homeDeliveryPremiumType = homeDeliveryPremiumType;
    }
