...
public class NetExplosiveDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.NetExplosiveClassificationType type;
    ...
    public NetExplosiveDetail(
           com.proquifa.net.negocio.envio.ship.stub.NetExplosiveClassificationType type,
     ...
     * @return type
     */
    public com.proquifa.net.negocio.envio.ship.stub.NetExplosiveClassificationType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.NetExplosiveClassificationType type) {
        this.type = type;
    }
