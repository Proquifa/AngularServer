...
public class HazardousCommodityQuantityDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityQuantityType quantityType;
    ...
    public HazardousCommodityQuantityDetail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityQuantityType quantityType) {
           this.amount = amount;
           this.units = units;
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityQuantityType getQuantityType() {
        return quantityType;
    }
     ...
     */
    public void setQuantityType(com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityQuantityType quantityType) {
        this.quantityType = quantityType;
    }
