...
public class AncillaryFeeAndTax  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.AncillaryFeeAndTaxType type;
    ...
    public AncillaryFeeAndTax(
           com.proquifa.net.negocio.envio.ship.stub.AncillaryFeeAndTaxType type,
     ...
     * @return type
     */
    public com.proquifa.net.negocio.envio.ship.stub.AncillaryFeeAndTaxType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.AncillaryFeeAndTaxType type) {
        this.type = type;
    }
