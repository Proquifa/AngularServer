...
public class BrokerDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.BrokerType type;

    private com.proquifa.net.negocio.envio.ship.stub.Party broker;

    public BrokerDetail() {
    }

    public BrokerDetail(
           com.proquifa.net.negocio.envio.ship.stub.BrokerType type,
           com.proquifa.net.negocio.envio.ship.stub.Party broker) {
           this.type = type;
           this.broker = broker;
    }
     ...
     * @return type
     */
    public com.proquifa.net.negocio.envio.ship.stub.BrokerType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.BrokerType type) {
        this.type = type;
    }
     ...
     * @return broker
     */
    public com.proquifa.net.negocio.envio.ship.stub.Party getBroker() {
        return broker;
    }
     ...
     * @param broker
     */
    public void setBroker(com.proquifa.net.negocio.envio.ship.stub.Party broker) {
        this.broker = broker;
    }
