...
public class CommercialInvoice  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.Money freightCharge;

    /* Any taxes or miscellaneous charges(other than Freight charges
     * or Insurance charges) that are associated with this shipment. */
    private com.proquifa.net.negocio.envio.ship.stub.Money taxesOrMiscellaneousCharge;

    /* Specifies which kind of charge is being recorded in the preceding
     * field. */
    private com.proquifa.net.negocio.envio.ship.stub.TaxesOrMiscellaneousChargeType taxesOrMiscellaneousChargeType;

    /* Any packing costs that are associated with this shipment. */
    private com.proquifa.net.negocio.envio.ship.stub.Money packingCosts;

    /* Any handling costs that are associated with this shipment. */
    private com.proquifa.net.negocio.envio.ship.stub.Money handlingCosts;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.PurposeOfShipmentType purpose;
    ...
    public CommercialInvoice(
           ...
           com.proquifa.net.negocio.envio.ship.stub.Money freightCharge,
           com.proquifa.net.negocio.envio.ship.stub.Money taxesOrMiscellaneousCharge,
           com.proquifa.net.negocio.envio.ship.stub.TaxesOrMiscellaneousChargeType taxesOrMiscellaneousChargeType,
           com.proquifa.net.negocio.envio.ship.stub.Money packingCosts,
           com.proquifa.net.negocio.envio.ship.stub.Money handlingCosts,
           java.lang.String specialInstructions,
           java.lang.String declarationStatement,
           java.lang.String paymentTerms,
           com.proquifa.net.negocio.envio.ship.stub.PurposeOfShipmentType purpose,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.Money getFreightCharge() {
     ...
     */
    public void setFreightCharge(com.proquifa.net.negocio.envio.ship.stub.Money freightCharge) {
        this.freightCharge = freightCharge;
    }
     ...
     * or Insurance charges) that are associated with this shipment.
     */
    public com.proquifa.net.negocio.envio.ship.stub.Money getTaxesOrMiscellaneousCharge() {
     ...
     * or Insurance charges) that are associated with this shipment.
     */
    public void setTaxesOrMiscellaneousCharge(com.proquifa.net.negocio.envio.ship.stub.Money taxesOrMiscellaneousCharge) {
        this.taxesOrMiscellaneousCharge = taxesOrMiscellaneousCharge;
    }
     ...
     * field.
     */
    public com.proquifa.net.negocio.envio.ship.stub.TaxesOrMiscellaneousChargeType getTaxesOrMiscellaneousChargeType() {
     ...
     * field.
     */
    public void setTaxesOrMiscellaneousChargeType(com.proquifa.net.negocio.envio.ship.stub.TaxesOrMiscellaneousChargeType taxesOrMiscellaneousChargeType) {
        this.taxesOrMiscellaneousChargeType = taxesOrMiscellaneousChargeType;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.Money getPackingCosts() {
        return packingCosts;
    }
     ...
     */
    public void setPackingCosts(com.proquifa.net.negocio.envio.ship.stub.Money packingCosts) {
        this.packingCosts = packingCosts;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.Money getHandlingCosts() {
     ...
     */
    public void setHandlingCosts(com.proquifa.net.negocio.envio.ship.stub.Money handlingCosts) {
        this.handlingCosts = handlingCosts;
    }
     ...
     * for a Proforma Invoice.
     */
    public com.proquifa.net.negocio.envio.ship.stub.PurposeOfShipmentType getPurpose() {
        return purpose;
    }
     ...
     * for a Proforma Invoice.
     */
    public void setPurpose(com.proquifa.net.negocio.envio.ship.stub.PurposeOfShipmentType purpose) {
        this.purpose = purpose;
    }
