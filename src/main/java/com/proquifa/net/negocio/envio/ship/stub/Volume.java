...
public class Volume  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.VolumeUnits units;
    ...
    public Volume(
           com.proquifa.net.negocio.envio.ship.stub.VolumeUnits units,
     ...
     * @return units
     */
    public com.proquifa.net.negocio.envio.ship.stub.VolumeUnits getUnits() {
        return units;
    }
     ...
     * @param units
     */
    public void setUnits(com.proquifa.net.negocio.envio.ship.stub.VolumeUnits units) {
        this.units = units;
    }
