...
public class NaftaLowValueStatementDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.CustomsRoleType role;

    public NaftaLowValueStatementDetail() {
    }

    public NaftaLowValueStatementDetail(
           com.proquifa.net.negocio.envio.ship.stub.CustomsRoleType role) {
           this.role = role;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.CustomsRoleType getRole() {
        return role;
    }
     ...
     */
    public void setRole(com.proquifa.net.negocio.envio.ship.stub.CustomsRoleType role) {
        this.role = role;
    }
