...
public class NotificationDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.NotificationType notificationType;

    /* Specifies the email notification details. */
    private com.proquifa.net.negocio.envio.ship.stub.EMailDetail emailDetail;
    ...
    public NotificationDetail(
           com.proquifa.net.negocio.envio.ship.stub.NotificationType notificationType,
           com.proquifa.net.negocio.envio.ship.stub.EMailDetail emailDetail,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.NotificationType getNotificationType() {
     ...
     */
    public void setNotificationType(com.proquifa.net.negocio.envio.ship.stub.NotificationType notificationType) {
        this.notificationType = notificationType;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.EMailDetail getEmailDetail() {
        return emailDetail;
    }
     ...
     */
    public void setEmailDetail(com.proquifa.net.negocio.envio.ship.stub.EMailDetail emailDetail) {
        this.emailDetail = emailDetail;
    }
