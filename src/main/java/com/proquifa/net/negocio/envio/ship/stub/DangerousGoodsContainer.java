...
public class DangerousGoodsContainer  implements java.io.Serializable {
     ...
     * this container. */
    private com.proquifa.net.negocio.envio.ship.stub.HazardousContainerPackingType packingType;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.RadioactiveContainerClassType radioactiveContainerClass;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityContent[] hazardousCommodities;

    public DangerousGoodsContainer() {
    }

    public DangerousGoodsContainer(
           com.proquifa.net.negocio.envio.ship.stub.HazardousContainerPackingType packingType,
           java.lang.String containerType,
           com.proquifa.net.negocio.envio.ship.stub.RadioactiveContainerClassType radioactiveContainerClass,
           org.apache.axis.types.NonNegativeInteger numberOfContainers,
           com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityContent[] hazardousCommodities) {
     ...
     * this container.
     */
    public com.proquifa.net.negocio.envio.ship.stub.HazardousContainerPackingType getPackingType() {
        return packingType;
    }
     ...
     * this container.
     */
    public void setPackingType(com.proquifa.net.negocio.envio.ship.stub.HazardousContainerPackingType packingType) {
        this.packingType = packingType;
    }
     ...
     * the radioactive materials.
     */
    public com.proquifa.net.negocio.envio.ship.stub.RadioactiveContainerClassType getRadioactiveContainerClass() {
     ...
     * the radioactive materials.
     */
    public void setRadioactiveContainerClass(com.proquifa.net.negocio.envio.ship.stub.RadioactiveContainerClassType radioactiveContainerClass) {
        this.radioactiveContainerClass = radioactiveContainerClass;
    }
     ...
     * in the current container.
     */
    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityContent[] getHazardousCommodities() {
     ...
     * in the current container.
     */
    public void setHazardousCommodities(com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityContent[] hazardousCommodities) {
        this.hazardousCommodities = hazardousCommodities;
    }

    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityContent getHazardousCommodities(int i) {
        return this.hazardousCommodities[i];
    }

    public void setHazardousCommodities(int i, com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityContent _value) {
