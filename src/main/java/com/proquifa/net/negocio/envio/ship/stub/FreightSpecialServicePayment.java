...
public class FreightSpecialServicePayment  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.ShipmentSpecialServiceType specialService;

    /* Indicates who will pay for the special service. */
    private com.proquifa.net.negocio.envio.ship.stub.FreightShipmentRoleType paymentType;

    public FreightSpecialServicePayment() {
    }

    public FreightSpecialServicePayment(
           com.proquifa.net.negocio.envio.ship.stub.ShipmentSpecialServiceType specialService,
           com.proquifa.net.negocio.envio.ship.stub.FreightShipmentRoleType paymentType) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.ShipmentSpecialServiceType getSpecialService() {
     ...
     */
    public void setSpecialService(com.proquifa.net.negocio.envio.ship.stub.ShipmentSpecialServiceType specialService) {
        this.specialService = specialService;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.FreightShipmentRoleType getPaymentType() {
        return paymentType;
    }
     ...
     */
    public void setPaymentType(com.proquifa.net.negocio.envio.ship.stub.FreightShipmentRoleType paymentType) {
        this.paymentType = paymentType;
    }
