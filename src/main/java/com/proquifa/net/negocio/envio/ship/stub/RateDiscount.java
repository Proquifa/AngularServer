...
public class RateDiscount  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.RateDiscountType rateDiscountType;
    ...
    public RateDiscount(
           com.proquifa.net.negocio.envio.ship.stub.RateDiscountType rateDiscountType,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.RateDiscountType getRateDiscountType() {
        return rateDiscountType;
    }
     ...
     */
    public void setRateDiscountType(com.proquifa.net.negocio.envio.ship.stub.RateDiscountType rateDiscountType) {
        this.rateDiscountType = rateDiscountType;
    }
