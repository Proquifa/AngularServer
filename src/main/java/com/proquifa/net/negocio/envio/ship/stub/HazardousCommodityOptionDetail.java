...
public class HazardousCommodityOptionDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityLabelTextOptionType labelTextOption;
    ...
    public HazardousCommodityOptionDetail(
           com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityLabelTextOptionType labelTextOption,
     ...
     * for this commodity in this package.
     */
    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityLabelTextOptionType getLabelTextOption() {
     ...
     * for this commodity in this package.
     */
    public void setLabelTextOption(com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityLabelTextOptionType labelTextOption) {
        this.labelTextOption = labelTextOption;
    }
