...
public class ShipmentLegRateDetail  implements java.io.Serializable {
    ...
    /* Origin for this leg. */
    private com.proquifa.net.negocio.envio.ship.stub.Address legOrigin;

    /* Specifies the location id the origin of shipment leg. */
    private java.lang.String legOriginLocationId;

    /* Destination for this leg. */
    private com.proquifa.net.negocio.envio.ship.stub.Address legDestination;
    ...
    public ShipmentLegRateDetail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.Address legOrigin,
           java.lang.String legOriginLocationId,
           com.proquifa.net.negocio.envio.ship.stub.Address legDestination,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.Address getLegOrigin() {
        return legOrigin;
    }
     ...
     */
    public void setLegOrigin(com.proquifa.net.negocio.envio.ship.stub.Address legOrigin) {
        this.legOrigin = legOrigin;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.Address getLegDestination() {
     ...
     */
    public void setLegDestination(com.proquifa.net.negocio.envio.ship.stub.Address legDestination) {
        this.legDestination = legDestination;
    }
