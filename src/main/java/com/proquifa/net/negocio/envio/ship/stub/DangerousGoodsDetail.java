...
public class DangerousGoodsDetail  implements java.io.Serializable {
     ...
     * package. */
    private com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityOptionType[] options;

    /* Indicates whether there is additional customer provided packaging
     * enclosing the approved dangerous goods containers. */
    private com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsPackingOptionType packingOption;
     ...
     * commodities. */
    private com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsContainer[] containers;

    /* Description of the packaging of this commodity, suitable for
     * use on OP-900 and OP-950 forms. */
    private com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackagingDetail packaging;

    /* Name, title and place of the signatory for this shipment. */
    private com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsSignatory signatory;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.Contact infectiousSubstanceResponsibleContact;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.RadioactivityDetail radioactivityDetail;
    ...
    public DangerousGoodsDetail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityOptionType[] options,
           com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsPackingOptionType packingOption,
           java.lang.String referenceId,
           com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsContainer[] containers,
           com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackagingDetail packaging,
           com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsSignatory signatory,
           java.lang.String emergencyContactNumber,
           java.lang.String offeror,
           com.proquifa.net.negocio.envio.ship.stub.Contact infectiousSubstanceResponsibleContact,
           java.lang.String additionalHandling,
           com.proquifa.net.negocio.envio.ship.stub.RadioactivityDetail radioactivityDetail) {
     ...
     * package.
     */
    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityOptionType[] getOptions() {
        return options;
    }
     ...
     * package.
     */
    public void setOptions(com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityOptionType[] options) {
        this.options = options;
    }

    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityOptionType _value) {
     ...
     * enclosing the approved dangerous goods containers.
     */
    public com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsPackingOptionType getPackingOption() {
     ...
     * enclosing the approved dangerous goods containers.
     */
    public void setPackingOption(com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsPackingOptionType packingOption) {
        this.packingOption = packingOption;
    }
     ...
     * commodities.
     */
    public com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsContainer[] getContainers() {
        return containers;
    }
     ...
     * commodities.
     */
    public void setContainers(com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsContainer[] containers) {
        this.containers = containers;
    }

    public com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsContainer getContainers(int i) {
        return this.containers[i];
    }

    public void setContainers(int i, com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsContainer _value) {
     ...
     * use on OP-900 and OP-950 forms.
     */
    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackagingDetail getPackaging() {
        return packaging;
    }
     ...
     * use on OP-900 and OP-950 forms.
     */
    public void setPackaging(com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityPackagingDetail packaging) {
        this.packaging = packaging;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsSignatory getSignatory() {
        return signatory;
    }
     ...
     */
    public void setSignatory(com.proquifa.net.negocio.envio.ship.stub.DangerousGoodsSignatory signatory) {
        this.signatory = signatory;
    }
     ...
     * the infectious substances, if any, in the dangerous goods shipment.
     */
    public com.proquifa.net.negocio.envio.ship.stub.Contact getInfectiousSubstanceResponsibleContact() {
     ...
     * the infectious substances, if any, in the dangerous goods shipment.
     */
    public void setInfectiousSubstanceResponsibleContact(com.proquifa.net.negocio.envio.ship.stub.Contact infectiousSubstanceResponsibleContact) {
        this.infectiousSubstanceResponsibleContact = infectiousSubstanceResponsibleContact;
    }
     ...
     * if the package contains radioactive materials.
     */
    public com.proquifa.net.negocio.envio.ship.stub.RadioactivityDetail getRadioactivityDetail() {
     ...
     * if the package contains radioactive materials.
     */
    public void setRadioactivityDetail(com.proquifa.net.negocio.envio.ship.stub.RadioactivityDetail radioactivityDetail) {
        this.radioactivityDetail = radioactivityDetail;
    }
