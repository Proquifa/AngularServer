...
public class ShippingDocumentEMailRecipient  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.EMailNotificationRecipientType recipientType;
    ...
    public ShippingDocumentEMailRecipient(
           com.proquifa.net.negocio.envio.ship.stub.EMailNotificationRecipientType recipientType,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.EMailNotificationRecipientType getRecipientType() {
     ...
     */
    public void setRecipientType(com.proquifa.net.negocio.envio.ship.stub.EMailNotificationRecipientType recipientType) {
        this.recipientType = recipientType;
    }
