...
public class StringBarcode  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.StringBarcodeType type;
    ...
    public StringBarcode(
           com.proquifa.net.negocio.envio.ship.stub.StringBarcodeType type,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.StringBarcodeType getType() {
        return type;
    }
     ...
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.StringBarcodeType type) {
        this.type = type;
    }
