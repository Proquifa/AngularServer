...
public class ServiceDescription  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.ProductName[] names;
    ...
    public ServiceDescription(
           ...
           com.proquifa.net.negocio.envio.ship.stub.ProductName[] names,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.ProductName[] getNames() {
        return names;
    }
     ...
     */
    public void setNames(com.proquifa.net.negocio.envio.ship.stub.ProductName[] names) {
        this.names = names;
    }

    public com.proquifa.net.negocio.envio.ship.stub.ProductName getNames(int i) {
        return this.names[i];
    }

    public void setNames(int i, com.proquifa.net.negocio.envio.ship.stub.ProductName _value) {
        this.names[i] = _value;
    }
