...
public class EdtCommodityTax  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.EdtTaxDetail[] taxes;
    ...
    public EdtCommodityTax(
           ...
           com.proquifa.net.negocio.envio.ship.stub.EdtTaxDetail[] taxes) {
     ...
     * @return taxes
     */
    public com.proquifa.net.negocio.envio.ship.stub.EdtTaxDetail[] getTaxes() {
        return taxes;
    }
     ...
     * @param taxes
     */
    public void setTaxes(com.proquifa.net.negocio.envio.ship.stub.EdtTaxDetail[] taxes) {
        this.taxes = taxes;
    }

    public com.proquifa.net.negocio.envio.ship.stub.EdtTaxDetail getTaxes(int i) {
        return this.taxes[i];
    }

    public void setTaxes(int i, com.proquifa.net.negocio.envio.ship.stub.EdtTaxDetail _value) {
        this.taxes[i] = _value;
    }
