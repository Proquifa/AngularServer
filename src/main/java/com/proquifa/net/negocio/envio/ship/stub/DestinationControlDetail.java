...
public class DestinationControlDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.DestinationControlStatementType[] statementTypes;
    ...
    public DestinationControlDetail(
           com.proquifa.net.negocio.envio.ship.stub.DestinationControlStatementType[] statementTypes,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.DestinationControlStatementType[] getStatementTypes() {
        return statementTypes;
    }
     ...
     */
    public void setStatementTypes(com.proquifa.net.negocio.envio.ship.stub.DestinationControlStatementType[] statementTypes) {
        this.statementTypes = statementTypes;
    }

    public com.proquifa.net.negocio.envio.ship.stub.DestinationControlStatementType getStatementTypes(int i) {
        return this.statementTypes[i];
    }

    public void setStatementTypes(int i, com.proquifa.net.negocio.envio.ship.stub.DestinationControlStatementType _value) {
