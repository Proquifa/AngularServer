...
public class Payor  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.Party responsibleParty;

    public Payor() {
    }

    public Payor(
           com.proquifa.net.negocio.envio.ship.stub.Party responsibleParty) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.Party getResponsibleParty() {
        return responsibleParty;
    }
     ...
     */
    public void setResponsibleParty(com.proquifa.net.negocio.envio.ship.stub.Party responsibleParty) {
        this.responsibleParty = responsibleParty;
    }
