...
public class RecipientCustomsId  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.RecipientCustomsIdType type;
    ...
    public RecipientCustomsId(
           com.proquifa.net.negocio.envio.ship.stub.RecipientCustomsIdType type,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.RecipientCustomsIdType getType() {
        return type;
    }
     ...
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.RecipientCustomsIdType type) {
        this.type = type;
    }
