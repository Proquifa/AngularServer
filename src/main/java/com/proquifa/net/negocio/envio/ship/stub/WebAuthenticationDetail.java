...
public class WebAuthenticationDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.WebAuthenticationCredential parentCredential;

    /* Credential used to authenticate a specific software application.
     * This value is provided by FedEx after registration. */
    private com.proquifa.net.negocio.envio.ship.stub.WebAuthenticationCredential userCredential;

    public WebAuthenticationDetail() {
    }

    public WebAuthenticationDetail(
           com.proquifa.net.negocio.envio.ship.stub.WebAuthenticationCredential parentCredential,
           com.proquifa.net.negocio.envio.ship.stub.WebAuthenticationCredential userCredential) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.WebAuthenticationCredential getParentCredential() {
     ...
     */
    public void setParentCredential(com.proquifa.net.negocio.envio.ship.stub.WebAuthenticationCredential parentCredential) {
        this.parentCredential = parentCredential;
    }
     ...
     * This value is provided by FedEx after registration.
     */
    public com.proquifa.net.negocio.envio.ship.stub.WebAuthenticationCredential getUserCredential() {
     ...
     * This value is provided by FedEx after registration.
     */
    public void setUserCredential(com.proquifa.net.negocio.envio.ship.stub.WebAuthenticationCredential userCredential) {
        this.userCredential = userCredential;
    }
