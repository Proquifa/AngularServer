...
public class CompletedPackageDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.TrackingId[] trackingIds;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.OversizeClassType oversizeClass;

    /* All package-level rating data for this package, which may include
     * data for multiple rate types. */
    private com.proquifa.net.negocio.envio.ship.stub.PackageRating packageRating;

    private com.proquifa.net.negocio.envio.ship.stub.PackageOperationalDetail operationalDetail;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.ShippingDocument[] packageDocuments;

    /* Specifies the information associated with this package that
     * has COD special service in a ground shipment. */
    private com.proquifa.net.negocio.envio.ship.stub.CodReturnPackageDetail codReturnDetail;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.SignatureOptionType signatureOption;

    private com.proquifa.net.negocio.envio.ship.stub.Weight dryIceWeight;
     ...
     * data. */
    private com.proquifa.net.negocio.envio.ship.stub.CompletedHazardousPackageDetail hazardousPackageDetail;
    ...
    public CompletedPackageDetail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.TrackingId[] trackingIds,
           org.apache.axis.types.NonNegativeInteger groupNumber,
           com.proquifa.net.negocio.envio.ship.stub.OversizeClassType oversizeClass,
           com.proquifa.net.negocio.envio.ship.stub.PackageRating packageRating,
           com.proquifa.net.negocio.envio.ship.stub.PackageOperationalDetail operationalDetail,
           com.proquifa.net.negocio.envio.ship.stub.ShippingDocument label,
           com.proquifa.net.negocio.envio.ship.stub.ShippingDocument[] packageDocuments,
           com.proquifa.net.negocio.envio.ship.stub.CodReturnPackageDetail codReturnDetail,
           com.proquifa.net.negocio.envio.ship.stub.SignatureOptionType signatureOption,
           com.proquifa.net.negocio.envio.ship.stub.Weight dryIceWeight,
           com.proquifa.net.negocio.envio.ship.stub.CompletedHazardousPackageDetail hazardousPackageDetail) {
     ...
     * @return trackingIds
     */
    public com.proquifa.net.negocio.envio.ship.stub.TrackingId[] getTrackingIds() {
        return trackingIds;
    }
     ...
     * @param trackingIds
     */
    public void setTrackingIds(com.proquifa.net.negocio.envio.ship.stub.TrackingId[] trackingIds) {
        this.trackingIds = trackingIds;
    }

    public com.proquifa.net.negocio.envio.ship.stub.TrackingId getTrackingIds(int i) {
        return this.trackingIds[i];
    }

    public void setTrackingIds(int i, com.proquifa.net.negocio.envio.ship.stub.TrackingId _value) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.OversizeClassType getOversizeClass() {
        return oversizeClass;
    }
     ...
     * @param oversizeClass
     */
    public void setOversizeClass(com.proquifa.net.negocio.envio.ship.stub.OversizeClassType oversizeClass) {
        this.oversizeClass = oversizeClass;
    }
     ...
     * data for multiple rate types.
     */
    public com.proquifa.net.negocio.envio.ship.stub.PackageRating getPackageRating() {
     ...
     * data for multiple rate types.
     */
    public void setPackageRating(com.proquifa.net.negocio.envio.ship.stub.PackageRating packageRating) {
        this.packageRating = packageRating;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.PackageOperationalDetail getOperationalDetail() {
        return operationalDetail;
    }
     ...
     */
    public void setOperationalDetail(com.proquifa.net.negocio.envio.ship.stub.PackageOperationalDetail operationalDetail) {
        this.operationalDetail = operationalDetail;
    }
     ...
     * barcodes). For use in loads after January, 2008.
     */
    public com.proquifa.net.negocio.envio.ship.stub.ShippingDocument[] getPackageDocuments() {
     ...
     * barcodes). For use in loads after January, 2008.
     */
    public void setPackageDocuments(com.proquifa.net.negocio.envio.ship.stub.ShippingDocument[] packageDocuments) {
        this.packageDocuments = packageDocuments;
    }

    public com.proquifa.net.negocio.envio.ship.stub.ShippingDocument getPackageDocuments(int i) {
        return this.packageDocuments[i];
    }

    public void setPackageDocuments(int i, com.proquifa.net.negocio.envio.ship.stub.ShippingDocument _value) {
     ...
     * has COD special service in a ground shipment.
     */
    public com.proquifa.net.negocio.envio.ship.stub.CodReturnPackageDetail getCodReturnDetail() {
     ...
     * has COD special service in a ground shipment.
     */
    public void setCodReturnDetail(com.proquifa.net.negocio.envio.ship.stub.CodReturnPackageDetail codReturnDetail) {
        this.codReturnDetail = codReturnDetail;
    }
     ...
     * the original value conflicted with other service features in the shipment.
     */
    public com.proquifa.net.negocio.envio.ship.stub.SignatureOptionType getSignatureOption() {
     ...
     * the original value conflicted with other service features in the shipment.
     */
    public void setSignatureOption(com.proquifa.net.negocio.envio.ship.stub.SignatureOptionType signatureOption) {
        this.signatureOption = signatureOption;
    }
     ...
     * @return dryIceWeight
     */
    public com.proquifa.net.negocio.envio.ship.stub.Weight getDryIceWeight() {
        return dryIceWeight;
    }
     ...
     * @param dryIceWeight
     */
    public void setDryIceWeight(com.proquifa.net.negocio.envio.ship.stub.Weight dryIceWeight) {
        this.dryIceWeight = dryIceWeight;
    }
     ...
     * data.
     */
    public com.proquifa.net.negocio.envio.ship.stub.CompletedHazardousPackageDetail getHazardousPackageDetail() {
     ...
     * data.
     */
    public void setHazardousPackageDetail(com.proquifa.net.negocio.envio.ship.stub.CompletedHazardousPackageDetail hazardousPackageDetail) {
        this.hazardousPackageDetail = hazardousPackageDetail;
    }
