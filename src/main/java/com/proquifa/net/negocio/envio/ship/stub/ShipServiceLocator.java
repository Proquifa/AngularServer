...
public class ShipServiceLocator extends org.apache.axis.client.Service implements com.proquifa.net.negocio.envio.ship.stub.ShipService {
    ...
    private java.lang.String ShipServicePort_address = "https://ws.fedex.com:443/web-services/ship";
    ...
    public com.proquifa.net.negocio.envio.ship.stub.ShipPortType getShipServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.proquifa.net.negocio.envio.ship.stub.ShipPortType getShipServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.proquifa.net.negocio.envio.ship.stub.ShipServiceSoapBindingStub _stub = new com.proquifa.net.negocio.envio.ship.stub.ShipServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.proquifa.net.negocio.envio.ship.stub.ShipPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.proquifa.net.negocio.envio.ship.stub.ShipServiceSoapBindingStub _stub = new com.proquifa.net.negocio.envio.ship.stub.ShipServiceSoapBindingStub(new java.net.URL(ShipServicePort_address), this);
                _stub.setPortName(getShipServicePortWSDDServiceName());
                return _stub;
            }
        }
