...
public class CustomLabelBarcodeEntry  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.BarcodeSymbologyType barcodeSymbology;
    ...
    public CustomLabelBarcodeEntry(
           ...
           com.proquifa.net.negocio.envio.ship.stub.BarcodeSymbologyType barcodeSymbology) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.BarcodeSymbologyType getBarcodeSymbology() {
        return barcodeSymbology;
    }
     ...
     */
    public void setBarcodeSymbology(com.proquifa.net.negocio.envio.ship.stub.BarcodeSymbologyType barcodeSymbology) {
        this.barcodeSymbology = barcodeSymbology;
    }
