...
public class LiabilityCoverageDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.LiabilityCoverageType coverageType;

    /* Identifies the Liability Coverage Amount. For Jan 2010 this
     * value represents coverage amount per pound */
    private com.proquifa.net.negocio.envio.ship.stub.Money coverageAmount;

    public LiabilityCoverageDetail() {
    }

    public LiabilityCoverageDetail(
           com.proquifa.net.negocio.envio.ship.stub.LiabilityCoverageType coverageType,
           com.proquifa.net.negocio.envio.ship.stub.Money coverageAmount) {
     ...
     * @return coverageType
     */
    public com.proquifa.net.negocio.envio.ship.stub.LiabilityCoverageType getCoverageType() {
        return coverageType;
    }
     ...
     * @param coverageType
     */
    public void setCoverageType(com.proquifa.net.negocio.envio.ship.stub.LiabilityCoverageType coverageType) {
        this.coverageType = coverageType;
    }
     ...
     * value represents coverage amount per pound
     */
    public com.proquifa.net.negocio.envio.ship.stub.Money getCoverageAmount() {
     ...
     * value represents coverage amount per pound
     */
    public void setCoverageAmount(com.proquifa.net.negocio.envio.ship.stub.Money coverageAmount) {
        this.coverageAmount = coverageAmount;
    }
