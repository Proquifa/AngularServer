...
public class RadionuclideDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.RadionuclideActivity activity;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.PhysicalFormType physicalForm;
    ...
    public RadionuclideDetail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.RadionuclideActivity activity,
           java.lang.Boolean exceptedPackagingIsReportableQuantity,
           com.proquifa.net.negocio.envio.ship.stub.PhysicalFormType physicalForm,
     ...
     * @return activity
     */
    public com.proquifa.net.negocio.envio.ship.stub.RadionuclideActivity getActivity() {
        return activity;
    }
     ...
     * @param activity
     */
    public void setActivity(com.proquifa.net.negocio.envio.ship.stub.RadionuclideActivity activity) {
        this.activity = activity;
    }
     ...
     * @return physicalForm
     */
    public com.proquifa.net.negocio.envio.ship.stub.PhysicalFormType getPhysicalForm() {
        return physicalForm;
    }
     ...
     * @param physicalForm
     */
    public void setPhysicalForm(com.proquifa.net.negocio.envio.ship.stub.PhysicalFormType physicalForm) {
        this.physicalForm = physicalForm;
    }
