...
public class ShipmentDryIceDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.ShipmentDryIceProcessingOptionsRequested processingOptions;
    ...
    public ShipmentDryIceDetail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.ShipmentDryIceProcessingOptionsRequested processingOptions) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.ShipmentDryIceProcessingOptionsRequested getProcessingOptions() {
        return processingOptions;
    }
     ...
     */
    public void setProcessingOptions(com.proquifa.net.negocio.envio.ship.stub.ShipmentDryIceProcessingOptionsRequested processingOptions) {
        this.processingOptions = processingOptions;
    }
