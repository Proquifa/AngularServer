...
public class CustomDocumentDetail  implements java.io.Serializable {
    ...
    /* Applicable only to documents produced on thermal printers with
     * roll stock. */
    private com.proquifa.net.negocio.envio.ship.stub.LabelRotationType labelRotation;
    ...
    public CustomDocumentDetail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.LabelRotationType labelRotation,
     ...
     * roll stock.
     */
    public com.proquifa.net.negocio.envio.ship.stub.LabelRotationType getLabelRotation() {
     ...
     * roll stock.
     */
    public void setLabelRotation(com.proquifa.net.negocio.envio.ship.stub.LabelRotationType labelRotation) {
        this.labelRotation = labelRotation;
    }
