...
public class ValidatedHazardousCommodityDescription  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityAttributeType[] attributes;
    ...
    public ValidatedHazardousCommodityDescription(
           ...
           com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityAttributeType[] attributes,
     ...
     * @return attributes
     */
    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityAttributeType[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityAttributeType[] attributes) {
        this.attributes = attributes;
    }

    public com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityAttributeType getAttributes(int i) {
        return this.attributes[i];
    }

    public void setAttributes(int i, com.proquifa.net.negocio.envio.ship.stub.HazardousCommodityAttributeType _value) {
