...
public class InternationalControlledExportDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.InternationalControlledExportType type;
    ...
    public InternationalControlledExportDetail(
           com.proquifa.net.negocio.envio.ship.stub.InternationalControlledExportType type,
     ...
     * @return type
     */
    public com.proquifa.net.negocio.envio.ship.stub.InternationalControlledExportType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.InternationalControlledExportType type) {
        this.type = type;
    }
