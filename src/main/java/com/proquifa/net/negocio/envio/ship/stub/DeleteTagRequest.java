...
public class DeleteTagRequest  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.Payment payment;
    ...
    public DeleteTagRequest(
           ...
           com.proquifa.net.negocio.envio.ship.stub.Payment payment,
     ...
     * number for security purposes.
     */
    public com.proquifa.net.negocio.envio.ship.stub.Payment getPayment() {
        return payment;
    }
     ...
     * number for security purposes.
     */
    public void setPayment(com.proquifa.net.negocio.envio.ship.stub.Payment payment) {
        this.payment = payment;
    }
