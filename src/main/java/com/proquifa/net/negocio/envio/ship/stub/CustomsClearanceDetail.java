...
public class CustomsClearanceDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.BrokerDetail[] brokers;

    /* Interacts both with properties of the shipment and contractual
     * relationship with the shipper. */
    private com.proquifa.net.negocio.envio.ship.stub.ClearanceBrokerageType clearanceBrokerage;

    private com.proquifa.net.negocio.envio.ship.stub.CustomsOptionDetail customsOptions;

    private com.proquifa.net.negocio.envio.ship.stub.Party importerOfRecord;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.RecipientCustomsId recipientCustomsId;

    private com.proquifa.net.negocio.envio.ship.stub.Payment dutiesPayment;

    private com.proquifa.net.negocio.envio.ship.stub.InternationalDocumentContentType documentContent;
    ...
    private com.proquifa.net.negocio.envio.ship.stub.FreightOnValueType freightOnValue;

    /* Documents amount paid to third party for coverage of shipment
     * content. */
    private com.proquifa.net.negocio.envio.ship.stub.Money insuranceCharges;

    private java.lang.Boolean partiesToTransactionAreRelated;

    private com.proquifa.net.negocio.envio.ship.stub.CommercialInvoice commercialInvoice;

    private com.proquifa.net.negocio.envio.ship.stub.Commodity[] commodities;

    private com.proquifa.net.negocio.envio.ship.stub.ExportDetail exportDetail;

    private com.proquifa.net.negocio.envio.ship.stub.RegulatoryControlType[] regulatoryControls;

    private com.proquifa.net.negocio.envio.ship.stub.CustomsDeclarationStatementDetail declarationStatementDetail;

    public CustomsClearanceDetail() {
    }

    public CustomsClearanceDetail(
           com.proquifa.net.negocio.envio.ship.stub.BrokerDetail[] brokers,
           com.proquifa.net.negocio.envio.ship.stub.ClearanceBrokerageType clearanceBrokerage,
           com.proquifa.net.negocio.envio.ship.stub.CustomsOptionDetail customsOptions,
           com.proquifa.net.negocio.envio.ship.stub.Party importerOfRecord,
           com.proquifa.net.negocio.envio.ship.stub.RecipientCustomsId recipientCustomsId,
           com.proquifa.net.negocio.envio.ship.stub.Payment dutiesPayment,
           com.proquifa.net.negocio.envio.ship.stub.InternationalDocumentContentType documentContent,
           com.proquifa.net.negocio.envio.ship.stub.Money customsValue,
           com.proquifa.net.negocio.envio.ship.stub.FreightOnValueType freightOnValue,
           com.proquifa.net.negocio.envio.ship.stub.Money insuranceCharges,
           java.lang.Boolean partiesToTransactionAreRelated,
           com.proquifa.net.negocio.envio.ship.stub.CommercialInvoice commercialInvoice,
           com.proquifa.net.negocio.envio.ship.stub.Commodity[] commodities,
           com.proquifa.net.negocio.envio.ship.stub.ExportDetail exportDetail,
           com.proquifa.net.negocio.envio.ship.stub.RegulatoryControlType[] regulatoryControls,
           com.proquifa.net.negocio.envio.ship.stub.CustomsDeclarationStatementDetail declarationStatementDetail) {
     ...
     * @return brokers
     */
    public com.proquifa.net.negocio.envio.ship.stub.BrokerDetail[] getBrokers() {
        return brokers;
    }
     ...
     * @param brokers
     */
    public void setBrokers(com.proquifa.net.negocio.envio.ship.stub.BrokerDetail[] brokers) {
        this.brokers = brokers;
    }

    public com.proquifa.net.negocio.envio.ship.stub.BrokerDetail getBrokers(int i) {
        return this.brokers[i];
    }

    public void setBrokers(int i, com.proquifa.net.negocio.envio.ship.stub.BrokerDetail _value) {
     ...
     * relationship with the shipper.
     */
    public com.proquifa.net.negocio.envio.ship.stub.ClearanceBrokerageType getClearanceBrokerage() {
     ...
     * relationship with the shipper.
     */
    public void setClearanceBrokerage(com.proquifa.net.negocio.envio.ship.stub.ClearanceBrokerageType clearanceBrokerage) {
        this.clearanceBrokerage = clearanceBrokerage;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.CustomsOptionDetail getCustomsOptions() {
        return customsOptions;
    }
     ...
     */
    public void setCustomsOptions(com.proquifa.net.negocio.envio.ship.stub.CustomsOptionDetail customsOptions) {
        this.customsOptions = customsOptions;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.Party getImporterOfRecord() {
        return importerOfRecord;
    }
     ...
     */
    public void setImporterOfRecord(com.proquifa.net.negocio.envio.ship.stub.Party importerOfRecord) {
        this.importerOfRecord = importerOfRecord;
    }
     ...
     * the requirements on this information vary with destination country.
     */
    public com.proquifa.net.negocio.envio.ship.stub.RecipientCustomsId getRecipientCustomsId() {
     ...
     * the requirements on this information vary with destination country.
     */
    public void setRecipientCustomsId(com.proquifa.net.negocio.envio.ship.stub.RecipientCustomsId recipientCustomsId) {
        this.recipientCustomsId = recipientCustomsId;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.Payment getDutiesPayment() {
        return dutiesPayment;
    }
     ...
     * @param dutiesPayment
     */
    public void setDutiesPayment(com.proquifa.net.negocio.envio.ship.stub.Payment dutiesPayment) {
        this.dutiesPayment = dutiesPayment;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.InternationalDocumentContentType getDocumentContent() {
        return documentContent;
    }
     ...
     */
    public void setDocumentContent(com.proquifa.net.negocio.envio.ship.stub.InternationalDocumentContentType documentContent) {
        this.documentContent = documentContent;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.FreightOnValueType getFreightOnValue() {
     ...
     */
    public void setFreightOnValue(com.proquifa.net.negocio.envio.ship.stub.FreightOnValueType freightOnValue) {
        this.freightOnValue = freightOnValue;
    }
     ...
     * content.
     */
    public com.proquifa.net.negocio.envio.ship.stub.Money getInsuranceCharges() {
     ...
     * content.
     */
    public void setInsuranceCharges(com.proquifa.net.negocio.envio.ship.stub.Money insuranceCharges) {
        this.insuranceCharges = insuranceCharges;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.CommercialInvoice getCommercialInvoice() {
        return commercialInvoice;
    }
     ...
     */
    public void setCommercialInvoice(com.proquifa.net.negocio.envio.ship.stub.CommercialInvoice commercialInvoice) {
        this.commercialInvoice = commercialInvoice;
    }
     ...
     * @return commodities
     */
    public com.proquifa.net.negocio.envio.ship.stub.Commodity[] getCommodities() {
        return commodities;
    }
     ...
     * @param commodities
     */
    public void setCommodities(com.proquifa.net.negocio.envio.ship.stub.Commodity[] commodities) {
        this.commodities = commodities;
    }

    public com.proquifa.net.negocio.envio.ship.stub.Commodity getCommodities(int i) {
        return this.commodities[i];
    }

    public void setCommodities(int i, com.proquifa.net.negocio.envio.ship.stub.Commodity _value) {
     ...
     * @return exportDetail
     */
    public com.proquifa.net.negocio.envio.ship.stub.ExportDetail getExportDetail() {
        return exportDetail;
    }
     ...
     * @param exportDetail
     */
    public void setExportDetail(com.proquifa.net.negocio.envio.ship.stub.ExportDetail exportDetail) {
        this.exportDetail = exportDetail;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.RegulatoryControlType[] getRegulatoryControls() {
        return regulatoryControls;
    }
     ...
     */
    public void setRegulatoryControls(com.proquifa.net.negocio.envio.ship.stub.RegulatoryControlType[] regulatoryControls) {
        this.regulatoryControls = regulatoryControls;
    }

    public com.proquifa.net.negocio.envio.ship.stub.RegulatoryControlType getRegulatoryControls(int i) {
        return this.regulatoryControls[i];
    }

    public void setRegulatoryControls(int i, com.proquifa.net.negocio.envio.ship.stub.RegulatoryControlType _value) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.CustomsDeclarationStatementDetail getDeclarationStatementDetail() {
        return declarationStatementDetail;
    }
     ...
     */
    public void setDeclarationStatementDetail(com.proquifa.net.negocio.envio.ship.stub.CustomsDeclarationStatementDetail declarationStatementDetail) {
        this.declarationStatementDetail = declarationStatementDetail;
    }
