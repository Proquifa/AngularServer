...
public class FreightRateDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.FreightRateQuoteType quoteType;

    /* Specifies how total base charge is determined. */
    private com.proquifa.net.negocio.envio.ship.stub.FreightBaseChargeCalculationType baseChargeCalculation;

    /* Freight charges which accumulate to the total base charge for
     * the shipment. */
    private com.proquifa.net.negocio.envio.ship.stub.FreightBaseCharge[] baseCharges;

    /* Human-readable descriptions of additional information on this
     * shipment rating. */
    private com.proquifa.net.negocio.envio.ship.stub.FreightRateNotation[] notations;
    ...
    public FreightRateDetail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.FreightRateQuoteType quoteType,
           com.proquifa.net.negocio.envio.ship.stub.FreightBaseChargeCalculationType baseChargeCalculation,
           com.proquifa.net.negocio.envio.ship.stub.FreightBaseCharge[] baseCharges,
           com.proquifa.net.negocio.envio.ship.stub.FreightRateNotation[] notations) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.FreightRateQuoteType getQuoteType() {
        return quoteType;
    }
     ...
     */
    public void setQuoteType(com.proquifa.net.negocio.envio.ship.stub.FreightRateQuoteType quoteType) {
        this.quoteType = quoteType;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.FreightBaseChargeCalculationType getBaseChargeCalculation() {
     ...
     */
    public void setBaseChargeCalculation(com.proquifa.net.negocio.envio.ship.stub.FreightBaseChargeCalculationType baseChargeCalculation) {
        this.baseChargeCalculation = baseChargeCalculation;
    }
     ...
     * the shipment.
     */
    public com.proquifa.net.negocio.envio.ship.stub.FreightBaseCharge[] getBaseCharges() {
        return baseCharges;
    }
     ...
     * the shipment.
     */
    public void setBaseCharges(com.proquifa.net.negocio.envio.ship.stub.FreightBaseCharge[] baseCharges) {
        this.baseCharges = baseCharges;
    }

    public com.proquifa.net.negocio.envio.ship.stub.FreightBaseCharge getBaseCharges(int i) {
        return this.baseCharges[i];
    }

    public void setBaseCharges(int i, com.proquifa.net.negocio.envio.ship.stub.FreightBaseCharge _value) {
     ...
     * shipment rating.
     */
    public com.proquifa.net.negocio.envio.ship.stub.FreightRateNotation[] getNotations() {
        return notations;
    }
     ...
     * shipment rating.
     */
    public void setNotations(com.proquifa.net.negocio.envio.ship.stub.FreightRateNotation[] notations) {
        this.notations = notations;
    }

    public com.proquifa.net.negocio.envio.ship.stub.FreightRateNotation getNotations(int i) {
        return this.notations[i];
    }

    public void setNotations(int i, com.proquifa.net.negocio.envio.ship.stub.FreightRateNotation _value) {
