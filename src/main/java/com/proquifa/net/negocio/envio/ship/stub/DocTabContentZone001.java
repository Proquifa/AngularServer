...
public class DocTabContentZone001  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.DocTabZoneSpecification[] docTabZoneSpecifications;

    public DocTabContentZone001() {
    }

    public DocTabContentZone001(
           com.proquifa.net.negocio.envio.ship.stub.DocTabZoneSpecification[] docTabZoneSpecifications) {
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.DocTabZoneSpecification[] getDocTabZoneSpecifications() {
        return docTabZoneSpecifications;
    }
     ...
     */
    public void setDocTabZoneSpecifications(com.proquifa.net.negocio.envio.ship.stub.DocTabZoneSpecification[] docTabZoneSpecifications) {
        this.docTabZoneSpecifications = docTabZoneSpecifications;
    }

    public com.proquifa.net.negocio.envio.ship.stub.DocTabZoneSpecification getDocTabZoneSpecifications(int i) {
        return this.docTabZoneSpecifications[i];
    }

    public void setDocTabZoneSpecifications(int i, com.proquifa.net.negocio.envio.ship.stub.DocTabZoneSpecification _value) {
