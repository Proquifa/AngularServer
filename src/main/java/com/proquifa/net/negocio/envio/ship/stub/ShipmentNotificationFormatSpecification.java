...
public class ShipmentNotificationFormatSpecification  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.NotificationFormatType type;

    public ShipmentNotificationFormatSpecification() {
    }

    public ShipmentNotificationFormatSpecification(
           com.proquifa.net.negocio.envio.ship.stub.NotificationFormatType type) {
           this.type = type;
    }
     ...
     * @return type
     */
    public com.proquifa.net.negocio.envio.ship.stub.NotificationFormatType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.NotificationFormatType type) {
        this.type = type;
    }
