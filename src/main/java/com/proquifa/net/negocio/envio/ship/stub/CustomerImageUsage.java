...
public class CustomerImageUsage  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.CustomerImageUsageType type;

    private com.proquifa.net.negocio.envio.ship.stub.ImageId id;

    public CustomerImageUsage() {
    }

    public CustomerImageUsage(
           com.proquifa.net.negocio.envio.ship.stub.CustomerImageUsageType type,
           com.proquifa.net.negocio.envio.ship.stub.ImageId id) {
           this.type = type;
           this.id = id;
    }
     ...
     * @return type
     */
    public com.proquifa.net.negocio.envio.ship.stub.CustomerImageUsageType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.CustomerImageUsageType type) {
        this.type = type;
    }
     ...
     * @return id
     */
    public com.proquifa.net.negocio.envio.ship.stub.ImageId getId() {
        return id;
    }
     ...
     * @param id
     */
    public void setId(com.proquifa.net.negocio.envio.ship.stub.ImageId id) {
        this.id = id;
    }
