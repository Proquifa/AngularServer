...
public class Tax  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.TaxType taxType;
    ...
    public Tax(
           com.proquifa.net.negocio.envio.ship.stub.TaxType taxType,
     ...
     * @return taxType
     */
    public com.proquifa.net.negocio.envio.ship.stub.TaxType getTaxType() {
        return taxType;
    }
     ...
     * @param taxType
     */
    public void setTaxType(com.proquifa.net.negocio.envio.ship.stub.TaxType taxType) {
        this.taxType = taxType;
    }
