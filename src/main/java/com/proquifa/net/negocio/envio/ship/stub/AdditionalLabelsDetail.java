...
public class AdditionalLabelsDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.AdditionalLabelsType type;
    ...
    public AdditionalLabelsDetail(
           com.proquifa.net.negocio.envio.ship.stub.AdditionalLabelsType type,
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.AdditionalLabelsType getType() {
        return type;
    }
     ...
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.AdditionalLabelsType type) {
        this.type = type;
    }
