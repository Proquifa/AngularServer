...
public class CustomsOptionDetail  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.CustomsOptionType type;
    ...
    public CustomsOptionDetail(
           com.proquifa.net.negocio.envio.ship.stub.CustomsOptionType type,
     ...
     * @return type
     */
    public com.proquifa.net.negocio.envio.ship.stub.CustomsOptionType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.CustomsOptionType type) {
        this.type = type;
    }
