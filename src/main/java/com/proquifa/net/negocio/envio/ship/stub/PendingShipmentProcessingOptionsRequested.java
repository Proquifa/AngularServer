...
public class PendingShipmentProcessingOptionsRequested  implements java.io.Serializable {
    private com.proquifa.net.negocio.envio.ship.stub.PendingShipmentProcessingOptionType[] options;

    public PendingShipmentProcessingOptionsRequested() {
    }

    public PendingShipmentProcessingOptionsRequested(
           com.proquifa.net.negocio.envio.ship.stub.PendingShipmentProcessingOptionType[] options) {
     ...
     * @return options
     */
    public com.proquifa.net.negocio.envio.ship.stub.PendingShipmentProcessingOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.proquifa.net.negocio.envio.ship.stub.PendingShipmentProcessingOptionType[] options) {
        this.options = options;
    }

    public com.proquifa.net.negocio.envio.ship.stub.PendingShipmentProcessingOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.proquifa.net.negocio.envio.ship.stub.PendingShipmentProcessingOptionType _value) {
