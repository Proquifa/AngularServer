...
public class CompletedEtdDetail  implements java.io.Serializable {
    ...
    private com.proquifa.net.negocio.envio.ship.stub.CompletedEtdType type;

    private com.proquifa.net.negocio.envio.ship.stub.UploadDocumentReferenceDetail[] uploadDocumentReferenceDetails;
    ...
    public CompletedEtdDetail(
           ...
           com.proquifa.net.negocio.envio.ship.stub.CompletedEtdType type,
           com.proquifa.net.negocio.envio.ship.stub.UploadDocumentReferenceDetail[] uploadDocumentReferenceDetails) {
     ...
     * @return type
     */
    public com.proquifa.net.negocio.envio.ship.stub.CompletedEtdType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.proquifa.net.negocio.envio.ship.stub.CompletedEtdType type) {
        this.type = type;
    }
     ...
     */
    public com.proquifa.net.negocio.envio.ship.stub.UploadDocumentReferenceDetail[] getUploadDocumentReferenceDetails() {
        return uploadDocumentReferenceDetails;
    }
     ...
     */
    public void setUploadDocumentReferenceDetails(com.proquifa.net.negocio.envio.ship.stub.UploadDocumentReferenceDetail[] uploadDocumentReferenceDetails) {
        this.uploadDocumentReferenceDetails = uploadDocumentReferenceDetails;
    }

    public com.proquifa.net.negocio.envio.ship.stub.UploadDocumentReferenceDetail getUploadDocumentReferenceDetails(int i) {
        return this.uploadDocumentReferenceDetails[i];
    }

    public void setUploadDocumentReferenceDetails(int i, com.proquifa.net.negocio.envio.ship.stub.UploadDocumentReferenceDetail _value) {
