...
public class Factura {	
	...
	public Double gettCambioE() {
		return tCambioE;
	}

	public void settCambioE(Double tCambioE) {
		this.tCambioE = tCambioE;
	}

	public Double getMonedaO() {
		return monedaO;
	}

	public void setMonedaO(Double monedaO) {
	...
	public Integer getTotalFactiuras() {
		return totalFactiuras;
	}

	public void setTotalFactiuras(Integer totalFactiuras) {
		this.totalFactiuras = totalFactiuras;
	}
	...
	public void setTotalPorCobrar(Double totalPorCobrar) {
	...
	public Double getImporteM() {
		return importeM;
	}

	public void setImporteM(Double importeM) {
